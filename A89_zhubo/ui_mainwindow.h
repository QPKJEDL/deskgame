...
""));
        ...
        pu_end->setMinimumSize(QSize(0, 70));
        QFont font1;
...
"}"));
        ...
        pu_exit->setMinimumSize(QSize(0, 70));
        QFont font2;
...
"}"));
        ...
        pu_start->setMinimumSize(QSize(0, 70));
        QFont font3;
...
"}"));
        ...
        pu_init->setMinimumSize(QSize(0, 70));
...
"}"));
        ...
        quickWidget->setSizeIncrement(QSize(10, 0));
        quickWidget->setBaseSize(QSize(100, 0));
        quickWidget->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 170, 255);"));
