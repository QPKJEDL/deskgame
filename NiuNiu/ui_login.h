...
"}"));
        ...
        horizontalLayout_2->addWidget(pu_enter);
...
"}"));
        ...
        verticalSpacer_2 = new QSpacerItem(20, 159, QSizePolicy::Minimum, QSizePolicy::Expanding);
    ...
    void retranslateUi(QWidget *Login)
    {
        ...
        comboBox->setItemText(0, QCoreApplication::translate("Login", "\347\211\233\347\211\233_CS3", nullptr));
