...
"background-color: rgb(0, 32, 57);"));
        ...
        three_five_pic = new QLabel(MRoomCard);
...
"background-color: rgb(0, 32, 57);"));
        ...
        three_four_pic = new QLabel(MRoomCard);
...
"background-color: rgb(0, 32, 57);"));
        ...
        two_five_pic = new QLabel(MRoomCard);
        two_five_pic->setObjectName(QString::fromUtf8("two_five_pic"));
        two_five_pic->setStyleSheet(QString::fromUtf8("border-radius:5px;\n"
"background-color: rgb(0, 32, 57);"));

        horizontalLayout_5->addWidget(two_five_pic);

        two_four_pic = new QLabel(MRoomCard);
        two_four_pic->setObjectName(QString::fromUtf8("two_four_pic"));
        two_four_pic->setStyleSheet(QString::fromUtf8("border-radius:5px;\n"
"background-color: rgb(0, 32, 57);"));

        horizontalLayout_5->addWidget(two_four_pic);
...
"background-color: rgb(200, 140, 0);"));
        ...
        horizontalLayout_23->addWidget(zhuang_result);
        ...
        horizontalLayout_23->setStretch(3, 1);
        horizontalLayout_23->setStretch(4, 1);
        horizontalLayout_23->setStretch(5, 1);
        horizontalLayout_23->setStretch(6, 1);
        horizontalLayout_23->setStretch(7, 1);
        horizontalLayout_23->setStretch(8, 4);
