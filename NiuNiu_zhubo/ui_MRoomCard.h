...
"background-color: rgb(0, 32, 57);"));
        ...
        horizontalLayout_9->addWidget(two_five_pic);
...
"background-color: rgb(200, 140, 0);"));
    ...
    void retranslateUi(QWidget *MRoomCard)
    {
        ...
        label_zhuang->setText(QCoreApplication::translate("MRoomCard", "\345\272\204\345\256\26611", nullptr));
