...
"background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 rgba(81, 81, 118, 255), stop:1 rgba(46, 48, 74, 255));"));
        ...
        pu_cancel->setGeometry(QRect(80, 300, 387, 80));
...
"}"));
        ...
        pu_enter->setGeometry(QRect(80, 214, 387, 80));
...
"}"));
        ...
        comboBox->setGeometry(QRect(40, 20, 439, 79));
...
"color: rgb(255, 255, 255);"));
        ...
        layoutWidget->setGeometry(QRect(20, 110, 493, 98));
