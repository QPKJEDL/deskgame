...
"}"));
        ...
        verticalSpacer_2 = new QSpacerItem(20, 129, QSizePolicy::Minimum, QSizePolicy::Expanding);
    ...
    void retranslateUi(QWidget *Login)
    {
        ...
        comboBox->setItemText(0, QCoreApplication::translate("Login", "\344\270\211\345\205\254\357\274\210SVIP8\357\274\211", nullptr));
