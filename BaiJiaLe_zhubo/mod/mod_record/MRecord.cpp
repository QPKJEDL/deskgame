...
void MRecord::apply_record(QString game, QString bankerPair, QString playerPair)
{
    append(game,bankerPair,playerPair);
...
void MRecord::append(QString game, QString bankerPair, QString playerPair)
{
...
void MRecord::update_panel(QJsonArray array)
{
    ...
    for(int i = 0;i < array.count();i++){
        ...
        QString playerPair = array.at(i)["playerPair"].toString();
