    ...
    , ui(new Ui::MainWindow)
{
    ...
    fiveArg.interface = "bjl_bingo_top_five";
    ...
    recordArg.interface = "bjl_dutch_game_list";
    ...
    startArg.interface = "bjl_count_down";
    ...
    uselessArg.interface = "bjl_game_burn";
    ...
    changBootArg.interface = "bjl_change_boot";
    ...
    initArg.interface = "bjl_desk_ini";
    module_init = new MInit(&initArg);

    MChatArg chatArg;
    chatArg.grid = ui->verticalLayout_4;
    chatArg.status = BAN;
